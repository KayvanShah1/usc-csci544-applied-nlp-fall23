...
class PathConfig:
    ...
    GLOVE_100d_File = os.path.join(CURRENT_DIR, "embeddings", "glove.6B.100d.txt")
...
def main():
    ...
    glove_embedding_matrix = create_glove_embedding_matrix(
        glove_word2idx, glove_emb_dict, DatasetConfig.embedding_size
    )
    ...
    weights_path = os.path.join(PathConfig.SAVED_MODELS_DIR, "bilstm_glove_embeddings_v1-best.pt")
